...
public interface IFileReader<TModel>
{
    ...
    TModel ReadFile(string filePath, long maxInputSize = ReaderDefaults.DefaultMaxInputSize);
    ...
    /// <returns>Parsed model.</returns>
    TModel ReadStream(Stream stream, long maxInputSize = ReaderDefaults.DefaultMaxInputSize);
    ...
    /// <returns>Parsed model.</returns>
    TModel ReadString(string content, long maxInputSize = ReaderDefaults.DefaultMaxInputSize);
